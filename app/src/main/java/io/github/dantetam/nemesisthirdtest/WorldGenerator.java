...
public class WorldGenerator {
    ...
    public void init() {
        int[][] biomes = new DiamondSquare(world.rows, 6, 0.4).seed(870).getIntTerrain(0, Tile.Biome.numBiomes - 1);
        int[][] terrains = new DiamondSquare(world.rows, 6, 0.4).seed(0417).getIntTerrain(0, Tile.Terrain.numTerrains - 1);
